...
// Prompt routes
router.post('/prompts', authMiddleware_1.default, promptController_1.default.createPrompt);
router.get('/prompts', authMiddleware_1.default, promptController_1.default.getPrompts);
router.get('/prompts/:id', authMiddleware_1.default, promptController_1.default.getPromptById);
router.put('/prompts/:id', authMiddleware_1.default, promptController_1.default.updatePrompt);
router.delete('/prompts/:id', authMiddleware_1.default, promptController_1.default.deletePrompt);
// Workflow routes
...
router.post('/gemini/test-prompt', authMiddleware_1.default, geminiController_1.default.testPrompt);
router.post('/gemini/generate-sfl', authMiddleware_1.default, geminiController_1.default.generateSFLFromGoal);
router.post('/gemini/regenerate-sfl', authMiddleware_1.default, geminiController_1.default.regenerateSFLFromSuggestion);
router.post('/gemini/generate-workflow', authMiddleware_1.default, geminiController_1.default.generateWorkflowFromGoal);
// Provider validation routes (protected - contains sensitive API key operations)
router.get('/providers/status', authMiddleware_1.default, providerController_1.default.getProviderStatus);
router.get('/providers/available', authMiddleware_1.default, providerController_1.default.getAvailableProviders);
router.get('/providers/health', authMiddleware_1.default, providerController_1.default.checkProviderHealth);
router.get('/providers/preferred', authMiddleware_1.default, providerController_1.default.getPreferredProvider);
router.post('/providers/validate', authMiddleware_1.default, providerController_1.default.validateProvider);
// Secure API key management routes (highly sensitive - requires authentication)
router.post('/providers/save-key', authMiddleware_1.default, providerController_1.default.saveApiKey);
router.delete('/providers/clear-keys', authMiddleware_1.default, providerController_1.default.clearApiKeys);
router.get('/providers/stored-keys', authMiddleware_1.default, providerController_1.default.getStoredKeys);
// AI proxy routes (protected)
router.post('/proxy/generate', authMiddleware_1.default, providerController_1.default.proxyGenerate);
