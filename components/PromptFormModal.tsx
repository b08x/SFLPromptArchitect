  ...
  >(
    ...
    <div>
      ...
      <div className="flex items-center space-x-2 mt-2">
        ...
        />
        <button type="button" onClick={() => handleAddNewOption(constantsKey, sflType, name)} className="px-3 py-2 text-sm bg-[#5c6f7e] hover:bg-opacity-90 rounded-md shrink-0">Add</button>
      </div>
    </div>
  );
                    ...
                    {(appConstants.targetAudiences || []).map(audience => (
                        <div key={audience} className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 rounded border-gray-400 text-[#c36e26] focus:ring-[#e2a32d] bg-[#212934]"
                            />
